...
public class TradeHandlerAndrew implements IVillageTradeHandler {
	...
	public void manipulateTradesForVillager(EntityVillager villager,
		...
		recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(8)), ItemsAndrew.butterDust));
		...
		recipeList.add(new MerchantRecipe(new ItemStack(ItemsAndrew.potatoLiver), Items.emerald));
		recipeList.add(new MerchantRecipe(new ItemStack(Items.emerald, random.nextInt(32)), ItemsAndrew.cactusGun));
	}
